...
class offer extends MX_Controller {
  ...
  public function viewdeals() {
      ...
      if($this->input->post('Search'))
      {
          ...
          //   'param16' => ''
          //   );
          // //$response['noofdeal'] = $this->supper_admin->call_procedure('proc_general', $parameter1);
          // p($response['noofdeal']);
...
public function statusoffer($id,$status) {
      ...
      @redirect(base_url()."admin/offer/viewdeals");
  } 
  ...
  public function addoffer() {
      ...
      if($this->input->post('submit')) 
      {
        ...
        if($this->form_validation->run() != false) {
              ...
              if(!empty($_FILES['o_menu']['name']) && $_FILES['o_menu']['size'] < $max_file_size ) {
                ...
                //p(dfdg);
              //exit;
              if($this->input->post('submit')=='Send To Retailer') {
             ...
             /* if($this->session->userdata('popcoin_login')->s_usertype==2 || $this->session->userdata('popcoin_login')->s_usertype==4) { 
              ...
              $this->session->set_flashdata('message', 'Your information has been saved successfully!');
                 ...
                 $o_menu = "";
                    $this->session->set_flashdata('message', 'Please upload image smaller than 200KB.');
                    redirect("admin/offer/addoffer"); 
   ...
   $parameter1 = array(
     ...
     $this->load->view('offer/addoffer',$response);
      //$this->load->view('offer/extendsdeals',$response);
  } 
                 ...
                 // p(count($_REQUEST['map_id']))  ; exit();
                  ...
                  if($this->input->post('o_offer_type')==1)
                  {
                    $parameter4 = array(
                                ...
                                'param2' => '',
                                'param3' => '-1',
                                'param4' => $this->input->post('o_start_time'),
                                'param5' => '',
                                'param6' => $this->input->post('o_end_time'),
                                'param7' => $this->input->post('o_start_timeopt'),
                                'param8' => '',
                                'param9' => $this->input->post('o_end_timeopt'),
                                'param10' => '',
                                'param11' => '',
                                'param12' => '',
                                'param13' => '',
...
public function extendsdeal($offer_id) {
      ...
      if($statvalue=='all')
      {
        ...
        $parameter1 = array('act_mode'=>'viewdealstatus','row_id'=>'','counname'=>'','coucode'=>'','commid'=>'');
         $response['dealstatus'] = $this->supper_admin->call_procedure('proc_master',$parameter1);
          ...
          $parameter2 = array('act_mode'=>'countdeal','row_id'=>'','counname'=>'','coucode'=>'','commid'=>'');
          $response['noofdeal'] = $this->supper_admin->call_procedureRow('proc_master',$parameter2);
...
//p($parameter1); exit;
          ...
          $response['dealstatus'] = $this->supper_admin->call_procedure('proc_master',$parameter1);
            ...
            $parameter3 = array('act_mode'=>'countdealbystatus','row_id'=>'','counname'=>$statvalue,
                                'coucode'=>'','commid'=>'');
            $response['noofdeal'] = $this->supper_admin->call_procedureRow('proc_master',$parameter3);
