                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, you can update details of store manager!
                                    <a href="<?php echo base_url();?>admin/login/viewemployee"><button type="button" style="float:right;">CANCEL</button></a></p>
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="empid" id="empid" value="<?php echo $vieww->retailer_codeid;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
