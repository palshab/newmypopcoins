                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-8">
                       <div class="right_main">
                        <div class="col-lg-6">
                            <div class="dash_box dash_box_1 d_box">
                        ...
                        <div class="col-lg-6">
                            <div class="dash_box dash_box_2 d_box">
                                 <h2>Total Sales of Day</h2>
                                <div class="dash_b_t dash_b_t1">
                                  <i class="fa fa-inr" aria-hidden="true"></i>
                                  <?php echo $result['pricofday']->total; ?></div>
                                <div class="das_box">
