...
?>
                             ...
                             <div class="sep_box">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                              <input id="submitBtn" onclick="checkmailid()" type="submit" name="submit" value="Submit" class="btn_button sub_btn"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
   ...
   function checkmailid()
   {
    ...
    $.ajax({  
          url: '<?php echo base_url() ?>admin/login/userinvitation',
          type:'POST',
          data:{'mail':email}, 
         success: function(data){ 
           if(data==1){

            $("#emailmsg").html("Invitation Already Sent ");
            return false;
           }
          ...
          url: '<?php echo base_url() ?>admin/login/userinvitation',
          type:'POST',
          data:{'submit':'submit','name':name,'email':email}, 
         success: function(data){ 
