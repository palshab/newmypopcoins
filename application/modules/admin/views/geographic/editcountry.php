  ...
  <div class="page_contant">
    ...
    <h2>Update Country</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="tbl_input"><input  type="text" name="couname" value="<?php echo $vieww->name ?>" id="couname"/></div>
            </div>
        </div>
        </div>
        ...
        <!-- <div class="col-lg-8">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="tbl_input"><input id="coucode" type="text" name="coucode" value="<?php echo $vieww->code ?>" /></div>
                </div>
            </div>
        </div> -->
        </div>
