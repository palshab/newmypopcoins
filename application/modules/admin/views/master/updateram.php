            ...
            <div class="row">
                ...
                <div class="page_contant">
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, you can update details of ram!
                                    <a href="<?php echo base_url();?>admin/master/ramdetails"><button type="button" style="float:right;">CANCEL</button></a></p>
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="ramname" id="ramname" value="<?php echo $vieww->name;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input id="ramempid" type="text" name="ramempid" value="<?php echo $vieww->ramempid;?>" readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                          
                                        ...
                                        <div class="sep_box">                                        
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="contact_no" id="contact_no" value="<?php echo $vieww->contactno;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="sep_box">                                        
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="officialid" id="officialid" value="<?php echo $vieww->officialid;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
