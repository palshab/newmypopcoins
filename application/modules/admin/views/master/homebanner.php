...
?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this Section Admin can Add Banner Images  .</p>
                            </div>
                        </div>
                        <div class="page_box">
                            <div class="sep_box">
                                    ...
                                    <table class="grid_tbl" id="example">
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo $value->title; ?></td>
                                            <td><img height="50px;" width="50px;" src="<?php echo base_url().'public/homebanner/'.$value->banner_image ;?>" ></td>
                                            
                                            <td><?php echo $value->url; ?></td>
                                            <td><a href="<?php echo base_url()?>admin/master/homebanneredit/<?php echo $value->id; ?>" ><i class="fa fa-pencil"></i></a>
                                            <a href="<?php echo base_url()?>admin/master/deletebanner/<?php echo $value->id?>" onclick="return confirm('Are you sure to delete?');"><i class="fa fa-trash fa-lg"></i></a></td>
                                        </tr>
                                    <?php } ?>
