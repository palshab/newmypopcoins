...
<div class="col-lg-10 col-lg-push-2">
 <div class="row">
  <div class="page_contant">
    <div class="col-lg-12">
    <div class="page_name">
    <h2>Modify Deal Status</h2>
    </div>
        <div class="page_box">
            <div class="sep_box">
        <div class="col-lg-12">
        <div style="text-align:right;">
            <a href="<?php echo base_url();?>admin/master/add_dealstatus"><button>CANCEL</button></a>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="tbl_input"><input  type="text" name="statusname"   id="statusname" value="<?php echo $vieww->deal_name; ?>" /></div>
            </div>
        </div>
        </div>
