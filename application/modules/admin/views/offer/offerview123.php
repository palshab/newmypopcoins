                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                ...
                                <p><strong>Store Title : <?php echo @$resdetail->r_res_name;?></strong></p>
                            </div>
                        </div>
                        ...
                        <div class="page_box">
                            <div class="sep_box">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="tbl_input">
                                                            <select name="s_admin_id" id="s_admin_id" onchange="return selectResdetails();">
                                                                ...
                                                                <option value="<?php echo $val->s_admin_id; ?>"><?php echo $val->s_username; ?></option>
                                                                <?php } ?>                                                          
                                                            </select>
                                                        </div>
                                                    </div>                                     
                                ...
                                <input type="hidden" name="restaurant_id" value="<?php echo $this->uri->segment(4);?>" />
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="tbl_input">
                                                            ...
                                                            <input type="text" name="Heading" value="" placeholder="05% Exclusive Cashback Offer"/>
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="tbl_input">
                                                            ...
                                                            <input type="text" name="Tagline" value="" placeholder=" Buy Any Personal Care Appliances Get 10%"/>
