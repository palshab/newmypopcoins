            ...
            <div class="row">
                <div class="page_contant">
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, admin can see the list of all deals!</p>
                            </div>
                        </div>
                        <div class="page_box">
                            <div class="sep_box">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="o_start_date" class="date start" placeholder="Start Date" />
                                    <input type="text" name="o_end_date" class="date end" placeholder="End Date" />
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                            	<div class="radio_div">
                                	...
                                	<div class="radio">  										                    
                                        <label class="radio-inline"><input type="radio" value="all" 
                                        onclick="changedealstatus('all')" name="optradio" checked >All</label>

                                       <!--  <label class="radio-inline"><input type="radio" value="draft" 
                                        onclick="changedealstatus('draft')" name="optradio">Draft</label> -->

                                       <!-- <label class="radio-inline"><input type="radio" value="pending" 
                                        onclick="changedealstatus('pending')" name="optradio">Pending</label> -->

                                        <label class="radio-inline"><input type="radio" value="approved" 
                                        onclick="changedealstatus('approved')" name="optradio">Approve</label>
                                        ...
                                        <label class="radio-inline"><input type="radio" value="closed" 
                                        onclick="changedealstatus('closed')" name="optradio">Closed</label>

                                        <label class="radio-inline"><input type="radio" value="canceled" 
                                        onclick="changedealstatus('canceled')" name="optradio">Canceled</label>

                                        <!--<label class="radio-inline"><input type="radio" value="running" 
                                        onclick="changedealstatus('running')" name="optradio">Running</label>-->
									</div> 
                                ...
                                <style>
                                    .noofdealsshow {
                                    background: none repeat scroll 0 0 #1870bb;
                                border: medium none;
                                 color: #fff;
                        font-size: 13px;
                        padding: 5px 10px
                                    ...
                                    <table class="grid_tbl" id="example">
                                        <thead>
                                            <tr>
                                             ...
                                             <tbody>
                                        <?php $i=0;  foreach ($vieww as $value) { $i++; ?>
                                            ...
                                            <td colspan="10">
                                                ...
                                                <div class="deal_detail" id="deal_detail" >
                                                    ...
                                                    <div class="deal_right">
                                                        ...
                                                        <div class="deal_row"> 
                                                         ...
                                                         <div class="deal_row"> 
                                                              <?php if($value->issueindeal !='') { echo
                                                                '<div class="deal_d2"><div class="deal_text">Issue <span>'.$value->issueindeal.'</span></div></div>';
                                                            }?>
                                                ...
                                                if($this->session->userdata('popcoin_login')->s_admin_id==$value->d_createdby)
                                                        ...
                                                        <div class="deal_row issuediv">
                                                            ...
                                                            <div class="deal_d1"><textarea class="t_area_<?php echo $i; ?>" cols="50" rows="4"></textarea>
