...
<div class="gridview">
<!-- <span class="noofdealsshow"  style="float: right;">Total no of deals : <?php echo $noofdeal->counts; ?></span> -->
                    ...
                    <?php if($this->session->userdata('popcoin_login')->s_usertype==4) { 
                                            if($value->o_status=='1') echo '<span style="color:green;">Active</span>'; else echo '<span style="color:red;">Inactive</span>';
                                                ...
                                                if($value->deal_status=='closed')
                                                {
                                                 ?>
                                                
                    <a href=<?php echo base_url(); ?>admin/offer/extendsdeal/<?php echo $value->offer_id?>>Extend Deal </a>

                                                 <?php }else{ ?>


                                                    <a href="<?php echo base_url()?>admin/offer/updateoffer/<?php echo $value->offer_id?>" ><i class="fa fa-pencil"></i> </a>
