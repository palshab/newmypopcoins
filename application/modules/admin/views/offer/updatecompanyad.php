        ...
        <div class="col-lg-10 col-lg-push-2">
            <div class="row">
                ...
                <div class="page_contant">
                    <div class="col-lg-12">
                        <div class="page_name">
                            <h2>Update Comapny Ad</h2>
                        </div>
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, admin can update company ad!
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                           <input type="text" name="comp_title" id="comp_title" value="<?php echo $vieww->comp_title; ?>" /> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                        
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <textarea name="comp_desc"><?php echo $vieww->comp_desc; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                        
