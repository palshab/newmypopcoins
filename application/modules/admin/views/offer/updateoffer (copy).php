                        ...
                        <div class="page_box">
                            <div class="sep_box">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="tbl_input">
                                                            <select name="s_admin_id" id="s_admin_id" onchange="return selectResdetails();">
                                                                ...
                                                                <?php foreach($viewstore as $val) { ?>
                                                                <option <?php if($offer->restaurant_id==$val->store_id) echo "selected"; ?>  value="<?php echo $val->store_id; ?>"><?php echo $val->s_name; ?></option>
                                                                <?php } ?>                                                          
                                                            </select>
                                                        </div>
                                                    </div>                                     
                                        ...
                                        <div class="sep_box">                                        
                                            <div class="col-lg-12">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="tbl_input">
                                                            <input type="text" name="tagline" id="tagline" value="<?php echo $offer->Tagline; ?>" />
                                                        </div>
                                                    </div>                                      
                                                </div>
                                            </div>                                             
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="tbl_input">
                                                            ...
                                                            <input type="text"  value="<?php echo $offer->commission; ?>" name="commission" value="" placeholder=""/>
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="o_start_time" autocomplete="off" class="time start ui-timepicker-input" value="<?php echo @$combined_start[-1];?>" />
                                                        </div>
                                                    </div>                                           
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="o_end_time" autocomplete="off" class="time start ui-timepicker-input" value="<?php echo @$combined_end[-1];?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                           
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="o_start_timeopt" autocomplete="off" class="time start ui-timepicker-input" value="<?php echo @$combined_startopt[-1];?>" />
                                                        </div>
                                                    </div>                                           
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="o_end_timeopt" autocomplete="off" class="time start ui-timepicker-input" value="<?php echo @$combined_endopt[-1];?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                           
                                ...
                                <?php if($offer->o_offer_type==2) { ?>
                                    ...
                                    <div class="col-lg-12"><div class="row"><div class="sep_box"><div class="col-lg-1"></div><div class="col-lg-1"><div class="tbl_input"><input type="checkbox" name="map_id[]" class="check" value="<?php echo $i; ?>" <?php if(in_array($i,$day_array)) echo "checked";?>/></div></div><div class="col-lg-2"><div class="tbl_input"><?php echo $day?></div></div><div class="col-lg-2"><div class="tbl_input"><input type="text" class="time start start_time" name="om_start_time_<?php echo $i; ?>" id="om_start_time_<?php echo $i; ?>" value="<?php echo @$combined_start[$i];?>" /></div></div><div class="col-lg-2"><div class="tbl_input"><input type="text" name="om_end_time_<?php echo $i; ?>" id="om_end_time_<?php echo $i; ?>" class="time end end_time" value="<?php echo @$combined_end[$i];?>" /></div></div><div class="col-lg-2"><div class="tbl_input"><input type="text" class="time start start_timeopt" name="om_start_timeopt_<?php echo $i; ?>" id="om_start_timeopt_<?php echo $i; ?>" value="<?php echo @$combined_startopt[$i];?>" /></div></div><div class="col-lg-2"><div class="tbl_input"><input type="text" name="om_end_timeopt_<?php echo $i; ?>" id="om_end_timeopt_<?php echo $i; ?>" class="time end end_timeopt" value="<?php echo @$combined_endopt[$i];?>" /></div></div></div></div></div>
                                    <?php } ?>
                                <?php } ?>
                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <input type="hidden" name="o_menu1" value="<?php echo $offer->o_menu;?>" />
                                                            <input type="file" name="o_menu1" id="o_menu" />
