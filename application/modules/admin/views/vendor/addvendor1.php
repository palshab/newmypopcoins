                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <!-- <span style="display:none" id="tooltipmsg">Password Should Be 7 digit</span> -->
                                                           <input type="text" title="" onclick="return CheckPassword();"  name="s_loginpassword" id="s_loginpassword"  />
...
function checkname(){
    ...
    { 
         var inputpass = $('#s_loginpassword').val(); 
         alert(inputpass);
      ...
      //   return false;
      // }
      // if(inputpass.value == form.username.value) {
      //   alert("Error: Password must be different from Username!");
      //   form.pwd1.focus();
      //   return false;
      // }
      // re = /[0-9]/;
      // if(!re.test(inputpass.value)) {
