                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <!-- <span style="display:none" id="tooltipmsg">Password Should Be 7 digit</span> -->
                                                           <input type="password" title="Password Should Be 7 digit"  name="s_loginpassword" id="s_loginpassword" maxlength="7" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $("#vendorForm").validate({
          ...
          messages: {
            ...
            retailer_type : "Please enter Type name!",
              ...
              agrementsigndate : "please enter retailer enrolement date!",
