                                    ...
                                    <div class="sep_box">
                                             ...
                                             <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" onblur="fillpassword()" name="s_mobileno" id="s_mobileno" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                         ...
                                         <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="tbl_text">Document (Upload soft cofy)</div>
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                           <input type="file" multiple name="doc" id="doc">
                                                        </div>
                                        ...
                                        <div class="sep_box">
                                             ...
                                             <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="tbl_text">Select Operation Lead Manager<span style="color:red;font-weight: bold;">*</span></div>
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            ...
                                                            <select id="operation" name="operation">
                                                                <?php
                                                                foreach ($operationmanager as $key => $value2) {
                                            ...
                                            <legend>RAM</legend>
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            ...
                                                            name="ramname">
                                                                ...
                                                                ?>
                                                 <option value="<?php echo $value2->ramid; ?>">
                                             ...
                                             <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                       <input type="text" name="ramemployeeid" value="" id="ramemployeeid">  
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <!-- <span style="display:none" id="tooltipmsg">Password Should Be 7 digit</span> -->
                                                           <input type="text" title=""  name="s_loginpassword" id="s_loginpassword"  />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                           ...
                                                           <select name="retailername" onchange="getdealcommission()"
                                                            class="retailernameid" data-live-search="true">
                            ...
                            <div class="sep_box">
                                           ...
                                           <!--  <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                          <div class="tbl_text">Cashback %<span style="color:red;font-weight: bold;">*</span></div>
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                          ...
                                          <?php } ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                               <input id="text" style="text-transform:lowercase;" type="text" name="password" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
  ...
  $(document).ready(function(){
    $("#vendorForm").validate({
          ...
          rules: {
              ...
              owndername : "required",
              storename :  {required:true, number:true, maxlength:10, minlength:10 },
            ...
            agrementsigndate : "required",
              ...
              s_mobileno :  {required:true, number:true, maxlength:10, minlength:10 },
          ...
          messages: {
            ...
            retailer_type : "Please enter Type name!",
              ...
              pincode : "please enter valid Pin Code, only numbers!",
              companyname : "please enter company name!",
              owndername : "please enter ownder name!",
              storename : {required:"Please enter contact number!", number:"Numbers only!", maxlength:"10 numbers only", minlength:"minimum 10 digit mobile no is required."},
              companyaddress : "please enter company address!",
              accountholder : "please enter account holder name!",
              accountnumber : {required : "please enter store name!", number : "Enter valid account number"},
              ifscode : "please enter ifsc code!",
              branchname : "please enter branch name!",
              bankname : "please enter bank name!",
              doc: "Plese Upload Soft Copy",
              operation: "Select operation manager",
              //bankdetails : "please enter bank details!",
              docrecdate : "please enter document received date!",
              retailerrenroldate : "please enter retailer enrolement date!",
              ...
              s_mobileno : {required:"Please enter contact number!", number:"Numbers only!", maxlength:"10 numbers only", minlength:"minimum 10 digit mobile no is required."},
              ...
              Alternateemailid : "Enter valid email id"
...
$(document).ready(function(){
    $("#storeForm").validate({
          ...
          rules: {
            ...
            storeno :  {required:true, number:true, maxlength:10, minlength:10 },
          ...
          messages: {
            ...
            storeno : {required:"Please enter contact number!", number:"Numbers only!", maxlength:"10 numbers only", minlength:"minimum 10 digit mobile no is required."},
            ...
            acc_number : {required:"account number required", number:"Numbers Only"},
            ...
            s_cashbackper : {required:"cashback required", number:"Numbers Only"},
            s_dealcommision : {required:"deal commission required", number:"Numbers Only"},
            managername : "manager name required",
            emailid : {required:"Email id required", email:"Enter valid email"},
            contactno : {required:"contact no required", number:"Numbers Only"},
...
function ramemployee(){
     ...
     $.ajax({
        ...
        success: function(data){
            //console.log(data);
            //$("#ramname").val('Pradeep');
            $("#ramemployeeid").val(data.ramempid);
            $("#officialid").val(data.officialid);
            $("#ramcontno").val(data.contactno);
            //
...
{
    var email = $("#s_mobileno").val();
    $('#s_loginpassword').val(email);
}
...
<script type="text/javascript">
 ...
 // {
  /*$(document).ready(function() {
        //$( "#retailernameid" ).change(function() {
           //   var reatiler_id = $("#retailernameid").val();
              $.ajax({
              url: '<?php echo base_url(); ?>admin/adminvender/viewretailer',
              type: 'POST',
              data: {'retailernameid':retailernameid},
             // var  option_brand = '<option value="">Select city</option>';
                $('#retailernameid').empty();
                $("#retailernameid").append(option_brand+data); 
              }
              });
      });
  });
