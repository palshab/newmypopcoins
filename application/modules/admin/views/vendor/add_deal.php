 <!-- <link href="//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/css/bootstrap-combined.no-icons.min.css" rel="stylesheet"> -->
  ...
  // Setup form validation on the #register-form element
    $("#addCont").validate({
        ...
        messages: {
            attname : "Type of Deal name is required",
            /*password: {
...
?>
                    ...
                    <div class="col-lg-12">
                        <div class="page_name">
                           <h2>Type of Deal  Name</h2>
                        </div>
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this Section Admin can Add Type of Deal .</p>
                            </div>
                        </div>
                        <div class="page_box">
                            <div class="sep_box">
                                    ...
                                    <div class="row">
                                        <div class="sep_box">
                                           ...
                                           <div class="col-lg-6">
                                                <div class="row ">
                                                    <div class="col-lg-4">
                                                        <div class="tbl_text">Type of Deal <span style="color:red;font-weight: bold;">*</span></div>
                                                    </div>
                                                    <div class="col-lg-8">
                                                <div class="tbl_input">
                                                <input type="text" name="typedeal_name" id="typedeal_name" />
