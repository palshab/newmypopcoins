                                    ...
                                    <div class="row">
                                     ...
                                     <div class="sep_box">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="s_username" value="<?php echo $vieww->s_username; ?>" id="s_username" readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                           ...
                                           <div class="col-lg-6">
                                            ...
                                            <legend>RAM</legend>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            ...
                                                            <select id="ramname" name="ramname" onchange="ramemployee()">
                                                               <?php
                                                                ...
                                                                ?>
                                                 <option <?php if($value2->ramid==$vieww->ramemp_id){ echo "selected"; } ?> value="<?php echo $value2->ramid; ?>">
                                             ...
                                             <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                       <input type="text" name="ramemployeeid" value="<?php echo $value2->ramempid; ?>" id="ramemployid"  >  
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text"  name="ramcontactno" value="<?php echo $value2->contactno; ?>"  id="ramcontno"> 
                                             ...
                                             <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                             <input type="text" value="<?php echo $value2->officialid; ?>" name="ramofficialid"  id="officialid"> 
...
function ramemployee(){
     ...
     $.ajax({
        ...
        success: function(data){
           ...
           // console.log(data);
            //$("#ramemployid").val(data.name);
            $("#ramemployid").val(data.ramempid);
