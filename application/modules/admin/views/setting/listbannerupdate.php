...
<body>
<?php  //p($listbannergetatt); die; ?>
<body>
<?php 

foreach($listbannergetatt as $val) { 
        ...
        <div class="col-lg-10 col-lg-push-2">
            <div class="row">
                ...
                <div class="page_contant">
                    <div class="col-lg-12">
                        <div class="page_name">
                            <h2>Edit Home page banners</h2>
                        </div>
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, admin can update banners for homepage!
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="title" id="title" value="<?php echo $listbannergetdata->title; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input id="discription" type="text" name="discription" value="<?php echo $listbannergetdata->banner_discription; ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                          
                                        ...
                                        <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input id="url" type="text" name="url"  value="<?php echo $listbannergetdata->url; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>   
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="tbl_input">
                                                            ...
                                                            <option value="<?php echo $value->type_id;  ?>" <?php if($value->type_id==$listbannergetdata->maincat) echo "selected"; ?> ><?php echo $value->type_title;  ?></option>
                                                                 <?php
                                                                  } ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="tbl_input">
                                                            ...
                                                            <select name="attrsub_id_<?php echo $attribute->id; ?>[]" multiple>
                                                                ...
                                                                <option value="<?php echo $val->id;?>" <?php if(in_array($val->id,$attr_sub_array)) echo "selected"; ?>><?php echo ucwords($val->attvalue);?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
