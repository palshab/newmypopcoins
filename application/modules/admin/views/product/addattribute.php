            ...
            <div class="row">
                ...
                <div class="page_contant">
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, admin can add product attribute!
                                <a href="<?php echo base_url();?>admin/product/viewattributes/<?php echo $this->uri->segment(4);?>"><button type="button" style="float:right;">CANCEL</button></a>
                              </p>
                            </div>
                        </div>
                        <div class="page_box">
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="pam_price" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                        
