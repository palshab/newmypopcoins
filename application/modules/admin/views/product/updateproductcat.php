            ...
            <div class="row">
                ...
                <div class="page_contant">
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, admin can update product category!
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="cat_name" id="cat_name" style="text-transform:lowercase" value="<?php echo $vieww->cat_name;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                        
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <textarea type="text" name="cat_desc" id="cat_desc"><?php echo $vieww->cat_desc;?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                        
