                                ...
                                <div class="gridview">
                                    <table class="grid_tbl" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                  <a href="<?php echo base_url()?>admin/adminvender/reatailerlistextra/<?php echo $value->s_admin_id?>" ><i class="fa fa-eye" style="font-size: 30px;"></i></a>
                                           </td>
