            ...
            <div class="row">
                ...
                <div class="page_contant">
                    <div class="col-lg-12">
                        ...
                        <div class="page_box">
                            <div class="col-lg-12">
                                <p> In this section, you can update tax!
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <input readonly type="text" name="tax_name" id="tax_name" 
                                                        value="<?php echo $vieww->commision_title;?>" />    
                                       ...
                                       <!--  <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input type="text" name="tax_name" id="tax_name" value="<?php echo $vieww->tax_name;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="sep_box">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="tbl_input">
                                                            <input id="tax_value" type="text" name="tax_value" value="<?php echo $vieww->commission_per;?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                          
