 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'ashutosh_api1.mindztechnology.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '6XAS9B582YVS7B5G' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AfTmh0Srg5UxMe07kgzLctgWZHzv' : 'PRODUCTION_SIGNATURE_GOES_HERE';
...
$api_username = $sandbox ? 'ashutosh_api1.mindztechnology.com' : 'LIVE_USERNAME_GOES_HERE';
$api_password = $sandbox ? '6XAS9B582YVS7B5G' : 'LIVE_PASSWORD_GOES_HERE';
$api_signature = $sandbox ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AfTmh0Srg5UxMe07kgzLctgWZHzv' : 'LIVE_SIGNATURE_GOES_HERE';
 ...
 */
$config['ApplicationID'] = $config['Sandbox'] ? '80W284485P519543T' : '7KA54677Y7296345B';

/*
 * PayPal Developer Account Email Address
 * This is the email address that you use to sign in to http://developer.paypal.com
 */
$config['DeveloperEmailAccount'] = 'ashutosh@mindztechnology.com';
